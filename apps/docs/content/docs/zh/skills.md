...
触发关键词（来自 [SKILL.md](https://github.com/1cli-team/one-cli/blob/master/packages/skills/one-cli/SKILL.md) frontmatter description）：
...
- [`packages/skills/one-cli/`](https://github.com/1cli-team/one-cli/tree/master/packages/skills/one-cli) —— SKILL.md + references/INDEX.md + 各 playbook
- [`packages/skills/one-migrate/`](https://github.com/1cli-team/one-cli/tree/master/packages/skills/one-migrate) —— 同上
