 ...
 *   - Store helper:    createStore() in src/lib/utils.ts       (zustand + devtools)
 *   - Global error:    src/app/global-error.tsx
 *   - Design tokens:   src/styles/tokens.css                   (CSS vars, light + dark)
 *
 ...
 *   - pages      → src/app/                  (App Router segments; this file is the home page)
 *
