...
// one-reference). Since Phase 5 it's a thin shim over internal/modules/skills/installer,
...
//
// New code should call internal/modules/skills/installer.Install directly.
package skills

import (
	"path/filepath"

	"github.com/torchstellar-team/one-cli/packages/cli/internal/modules/skills/installer"
